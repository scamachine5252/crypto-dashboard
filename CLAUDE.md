...
### Status: Trades sync fixed — unique constraint added, all categories fetched for Bybit and OKX
...
- `supabase/migrations/006_add_trades_unique_constraint.sql` — unique index on `(account_id, symbol, opened_at)` required for upsert deduplication
